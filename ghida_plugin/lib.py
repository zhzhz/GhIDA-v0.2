...
def get_ida_exported_files():
    ...
    # file_path = os.path.join(dirname, "ghida_exported")
...
def export_ida_project_to_xml():
    ...
    # print("GhIDA:: [DEBUG] EXPORT_XML_FILE: %s:%s",xml_file_path, bin_file_path)
    ...
    try:
        print("GhIDA:: [INFO] XML exporting start1------------")
...
def ghidra_headless(address,
    ...
    try:
        ...
        # output_path = "C:\\Users\\93249\\AppData\\Local\\Temp12134"

        # print("zz:ghidra_headless_path-------------------%s",ghidra_headless_path)
        # print("zz:xml_file_path-------------------%s",xml_file_path)
        # print("zz:ghidra_plugins_path-------------------%s",ghidra_plugins_path)
        # print("zz:output_path-------------------%s",output_path)
        # print("zz:address-------------------%s",address)
        ...
        if os.path.isfile(output_path):
            ...
            with open(output_path) as f_in:
                ...
                # print("hahahha--------222")
                decompiled_code = f_in.read()
                # print("hahahha--------%s",decompiled_code)
